...
docker build -t "$1"/php:7.1.10-apache_"$buildnumber" -t "$1"/php:latest_"$buildnumber" 7.1.10-apache
docker build -t "$1"/php:7.1.10-apache-xdebug_"$buildnumber" -t "$1"/php:latest-xdebug_"$buildnumber" 7.1.10-apache-xdebug
...
docker push "$1"/php:7.1.10-apache_"$buildnumber"
docker push "$1"/php:7.1.10-apache-xdebug_"$buildnumber"
