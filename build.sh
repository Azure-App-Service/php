...
docker build -t "$1"/php:7.0.6-apache_"$buildnumber" -t "$1"/php:latest_"$buildnumber" 7.0.6-apache
docker build -t "$1"/php:7.0.6-apache-xdebug_"$buildnumber" -t "$1"/php:latest-xdebug_"$buildnumber" 7.0.6-apache-xdebug
